...
title: ⛪ Pub Dartboard Review - Bishops Tavern
...
{% include figure.html
src="/images/bishops-tavern/board.jpg"
alt="A close up picture of the board"
caption="The board in Bishops Tavern"
%}
...
{% include figure.html
src="/images/bishops-tavern/oche.jpg"
alt="The oche is a mat below the board, with a dense table of numbers showing checkout routes with two or three darts in hand"
caption="The oche with handy checkout table"
%}

There is a chalkboard to the left of the board, suitably far away that one could score without being in danger from another player throwing darts. It's also a good sized board, meaning low scorers such as myself don't need to write particularly small. Also, plenty of space for a big game of [halve it](https://en.wikipedia.org/wiki/Halve_it). When I visited it was being used by Melissa to announce her birthday.

{% include figure.html
src="/images/bishops-tavern/chalkboard.jpg"
alt="A picture of the chalkboard which says Melissa was here on her birthday"
caption="Happy Birthday Melissa!"
%}
...
{% include figure.html
src="/images/bishops-tavern/wide.jpg"
alt="A wider shot of the oche showing the chalkboard, dartboard and windows"
caption="A wider shot of the oche"
%}
